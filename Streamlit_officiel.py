...
## Installe Streamlit si ce n'est pas déjà fait
#C:/Users/yacin/AppData/Local/Programs/Python/Python312/python.exe -m pip install streamlit
#Exécute le script Streamlit
#if ($?) {
 #C:/Users/yacin/AppData/Local/Programs/Python/Python312/python.exe -m streamlit run "C:/Users/yacin/OneDrive/Documents/GitHub/Streamlit_Analyse_du_bien_etre_sur_terre/eda_lm_1_(1).py"
#}
